...
export const SideCardData = [
  {
    ...
    items: [
      ...
      },
      {
        label: '西瓜視頻',
        image:
          'https://gd-hbimg.huaban.com/65130a3e6a139530bb03bd118e21a2603af7df4e1303b-OOzcBu_fw658webp',
  ...
  },
  {
    ...
    items: Array.from({ length: 6 }, (_, i) => ({
      label: '隨機名字',
      image:
        'https://img.tol.vip/avatar/WEIXIN/3aSuTGYTzjHvcHy0y0tH1eiShKRk9Sgd.jpg?_upt=de4a5c251709635127',
